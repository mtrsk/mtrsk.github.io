...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :slug some-experiments-with-erlang-and-nix
:CUSTOM_ID: some-experiments-with-erlang-and-nix
:END:

#+INCLUDE: "../blog/posts/experiments-with-erlang-and-nix.org"
...
:PROPERTIES:
:EXPORT_FILE_NAME: design-for-scalability-with-erlang-otp
:EXPORT_DATE: 2024-07-06
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :slug design-for-scalability-with-erlang-otp
:CUSTOM_ID: design-for-scalability-with-erlang-otp
:END:
