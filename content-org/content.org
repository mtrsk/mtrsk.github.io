...
#+NAME: export-posts
#+BEGIN_SRC shell :results raw :output drawer
...
** Erlang Datatypes
:PROPERTIES:
:EXPORT_FILE_NAME: erlang-datatypes
:EXPORT_DATE: 2024-09-23
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :slug erlang-datatypes
:CUSTOM_ID: erlang-datatypes
:END:

#+INCLUDE: "../notes/20240923220335-erlang_datatypes.org"
